...
- `knowledge-garden` 的 §2.2 狀態評估 或 §4 花園巡檢 發現「種子已達 🌿 以上但沒有視覺地圖」「研究專題 ≥3 顆種子但沒有地圖」時，自動呼叫本 skill 建立地圖，不需要等人類明確要求
- 建立後照常註冊到 Database，並更新種子/專題的「視覺地圖頁面」欄位——這樣才不會又被下一輪巡檢重複抓出來
